...
export const funnelObjectivesData = {
  ...
  ecommerce_cosmetic: { name: "เครื่องสำอาง", objectives: { tofu: ['Tutorial การใช้งาน', 'สร้าง Awareness'], mofu: ['รีวิวผลลัพธ์ Before/After', 'แจก Sample'], bofu: ['โปรโมชั่นซื้อ 1 แถม 1', 'สร้าง Loyalty Program'] } },
  ecommerce_supplement: { name: "อาหารเสริม", objectives: { tofu: ['ให้ความรู้ด้านสุขภาพ', 'สร้างความน่าเชื่อถือ'], mofu: ['ผลวิจัยรองรับ', 'รีวิวจากผู้ใช้จริง'], bofu: ['โปรแกรมสมัครสมาชิก', 'โปรโมชั่นพิเศษ'] } },
  ...
  ecommerce_digital: { name: "สินค้าดิจิทัล", objectives: { tofu: ['ให้ความรู้ฟรี (Webinar)', 'สร้าง Community'], mofu: ['แสดงตัวอย่างเนื้อหา', 'Testimonials'], bofu: ['ส่วนลด Early Bird', 'เสนอขายคอร์สเรียนขั้นสูง'] } },
  ...
  leadgen_service: { name: "ธุรกิจบริการ", objectives: { tofu: ['แสดงผลงาน (Portfolio)', 'สร้างความน่าเชื่อถือ'], mofu: ['ให้คำปรึกษาเบื้องต้น', 'รีวิวจากลูกค้า'], bofu: ['ประเมินราคาฟรี', 'โปรโมชั่นสำหรับลูกค้าใหม่'] } },
  ...
  info_product: { name: "คอร์สเรียน / E-Book", objectives: { tofu: ['ให้ความรู้ฟรี', 'สร้าง Community'], mofu: ['แสดงตัวอย่างเนื้อหา', 'Testimonials'], bofu: ['ส่วนลด Early Bird', 'เสนอขายคอร์สเรียนขั้นสูง'] } },
  saas: { name: "ธุรกิจ SaaS", objectives: { tofu: ['ให้ความรู้เกี่ยวกับปัญหาที่แก้ไขได้', 'สร้าง Awareness'], mofu: ['เสนอ Free Trial / Demo', 'Case Studies'], bofu: ['ส่วนลดสำหรับแผนรายปี', 'Onboarding Support'] } },
